...
const Layout = () => {
    ...
    const { allTasks , fetchTasks , error } = useContext(TaskContext);
    ...
    return (
        <>
            <div className='min-h-screen bg-gray-50'>
                <Navbar />
                <Sidebar />
                <div className='ml-0 xl:ml-64 lg:ml-64 md:ml-20 p-3 mb-8 sm:p-6 transition-all duration-300'>
                                        ...
                                        <div key={task._id }
                                            ...
                                            <div className='flex-1 min-w-0'>
                                                ...
                                                <p className='text-xs text-gray-500 mt-0.5'>
                                                    {task.createdAt ? new Date(task.createdAt).toLocaleDateString("en-GB") : "No Date"}
                                                </p>
                                            </div>
                                            <span className={` px-2 py-1 text-xs rounded-full shrink-0 ml-2 ${task.completed ? "bg-green-100 text-green-700" : "bg-orange-100 text-orange-600"}`}>
