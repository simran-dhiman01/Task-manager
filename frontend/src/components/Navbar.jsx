        ...
        <div ref={menuRef} className='relative'>
          <button
            ...
            <div className='relative'>
              {currentUser?.avatar ?
                (
                  <img src={currentUser?.avatar} alt="currentUser-profile" className='w-9 h-9 rounded-full shadow-sm' />
                ) : (
                  <div className='w-9 h-9 flex items-center justify-center rounded-full bg-orange-300 font-semibold shadow-sm text-white'>
          ...
          {menuOpen && (
            <ul className='absolute top-14 left-0 right-0 rounded-2xl bg-white/90 w-56 animate-fadeIn z-50 shadow-lg border border-purple-100'>
              <li className='px-2 py-1'>
                <button
                  ...
                  className='flex items-center gap-2 w-full px-4 py-2.5 text-left hover:bg-purple-50 text-sm text-gray-700 transition-colors group'
                  role='menuitem'>
                  <CiSettings className='w-5 h-5 text-gray-700 font-bold' />
                  Profile Settings
                </button>
              </li>
              ...
              <li className='px-2 py-1'>
                <button
                  ...
                  className='flex items-center gap-2 w-full px-4 py-2.5 text-left hover:bg-purple-50 text-sm text-red-600 transition-colors group'
                  role='menuitem'>
